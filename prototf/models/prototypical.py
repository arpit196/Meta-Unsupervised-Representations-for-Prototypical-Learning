...
class Prototypical(Model):
    ...
    def proto_enc(self, inputs):
        pro_encoder = tf.keras.layers.multiply([tf.convet_to_tensor(self.W[0]),self.l1])(inputs)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[1]),self.l2])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[2]),self.l3])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[3]),self.l3])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[4]),self.l3])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[5]),self.l6])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[6]),self.l7])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[7]),self.l8])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[8]),self.l9])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[9]),self.l10])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[10]),self.l11])(pro_encoder)
        pro_encoder = tf.keras.layers.multiply([tf.convert_to_tensor(self.W[11]),self.l12])(pro_encoder)
